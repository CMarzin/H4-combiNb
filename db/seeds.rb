...
Annonce.create(title: 'Annonce 1', description: 'Lorem ipsum lorem', location: 'Paris', start:'2017-12-17', end:'2017-12-31', creator_id: 1)
Annonce.create(title: 'Annonce 2', description: 'Ipsum lorem Ipsum', location: 'Amsterdam', start:'2017-12-20', end:'2018-01-15', creator_id: 2)