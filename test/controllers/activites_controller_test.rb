...
class ActivitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create activite" do
    assert_difference('Activite.count') do
      post activites_url, params: { activite: { description: @activite.description, location: @activite.location, titre: @activite.titre } }
    end
  ...
  test "should update activite" do
    patch activite_url(@activite), params: { activite: { description: @activite.description, location: @activite.location, titre: @activite.titre } }
